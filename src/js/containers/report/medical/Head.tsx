...
import {patientBeforeStatus} from "../config";
...
{/* todo:做个可以清除的combobox */}
					<Combobox data={profession} width={120} placeholder="非必填" require={false} hasSlideIcon={false} defaultVal={cpProfession} clickCallback={setComboboxObj} field="cpProfession" />
				</span>
				<span className="detail">
			...
			<div className="item-tr">
				...
				<span className="detail">
					<span className="require">职称：</span>
					<Combobox data={profession} placeholder={"非必填"} require={false} clickCallback={setComboboxObj} defaultVal={dProfession} field="dProfession" width={120} hasSlideIcon={false} />
				</span>
			...
			<div className="item-tr">
				...
				<span className="detail">
					<label >报告人：</label>
					<input type="text" required name="reporter" placeholder="" onChange={inputChange} defaultValue={reporter} className={"inp"} style={{ width: 90 }} />

				</span>
				<span className="detail">
					<span className="require">职称：</span>
					<Combobox data={profession} require={false} width={120} placeholder={"非必选"} clickCallback={setComboboxObj} defaultVal={rProfession} field="rProfession" hasSlideIcon={false} />
				</span>
			...
			<div className="item-tr">
				...
				<span className="detail">
					<span >事发场所：</span>
					<Combobox data={happenScene} width={140} hasSlideIcon={false}  renderClick={true} defaultVal={incidentSceneId} clickCallback={changeHappenceSon} field="incidentSceneId" />
					&nbsp;&nbsp;
